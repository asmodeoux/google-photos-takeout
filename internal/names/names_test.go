...
func TestChooseRule(t *testing.T) {
	cases := []struct {
		...
		{"auto", "9p", false, Portable, false},
		{"auto", "cifs", false, Portable, false},
		{"auto", "smbfs", false, Portable, false},
		{"auto", "0x1234", false, Portable, false},
		{"auto", "", false, Portable, false},
		{"apple", "0x1234", false, Apple, false},
		{"apple", "cifs", false, Apple, true},
